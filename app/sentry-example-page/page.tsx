	...
	return <div>
		...
		<main>
			...
			<p className="description">
				Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://wasek.sentry.io/issues/?project=4509624550359120">Issues Page</a>.
